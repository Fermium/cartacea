...
\fancypagestyle{empty}    {\fancyhf{}\fancyhead[L]{\includegraphics[height=0.5in, keepaspectratio=true]{templates/logo.eps}}}
\fancypagestyle{firstpage}{\fancyhf{}\fancyhead[L]{\includegraphics[height=0.5in, keepaspectratio=true]{templates/logo.eps}}}
\fancypagestyle{plain}    {\fancyhf{}\fancyhead[R]{\includegraphics[height=0.5in, keepaspectratio=true]{templates/logo.eps}}}
...
\backgroundsetup{%
  ...
  angle=0,
  opacity=.2,
  contents={\includegraphics[width=\paperwidth]{templates/background.eps}},
  hshift=8.8cm,
